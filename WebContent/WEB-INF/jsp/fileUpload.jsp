...
<form:form action="uploadfile" modelAttribute="fileuploadformbean" method="post" enctype="multipart/form-data" onsubmit="return validate_fileupload(this);">
		Certificate to upload: <input id="ufile" type="file" name="file"><br /> 

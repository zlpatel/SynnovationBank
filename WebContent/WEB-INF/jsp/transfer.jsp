...
<br><br>
<form>
Enter the account number to which you want to tranfer the amount: <input type="number" name="amount"><br>
Enter the amount (in USD) you want to tranfer :<input type="number" name="amount"><br>
<button type="button">MAKE TRANSFER</button>
</form>

...
<li class="active"><a href="MerchantSubmitPayment">Submit Payment</a></li>
</ul>
...
<form:form action="submitpayment" modelAttribute="merchantPaymentFormBean" method="post" enctype="multipart/form-data">
        ...
        <h4>Description<span class="label label-default">${merchantPaymentFormBean.notifications}</span></h4>

...
<input name="fname"  class = "form-control" style="width:200px;" placeholder = "First Name" maxlength="15" value="${addinternaluserformbean.fname}"/>
<br>
<input name="lname"  type="text" class = "form-control" style="width:200px;" placeholder = "Last Name" maxlength="14" value="${addinternaluserformbean.lname}"/>
<br>
<input name="address"  type="text" class = "form-control" style="width:200px;" placeholder = "Address" maxlength="50" value="${addinternaluserformbean.address}"/>
<br>
...
<br>
--%><input name="email"  type="text" class = "form-control" style="width:200px;" placeholder = "Email" maxlength="30" value="${addinternaluserformbean.email}"/>
<br><input name="username"  class = "form-control" style="width:200px;" placeholder = "Username" maxlength="15" value="${addinternaluserformbean.username}"/>
<br><input name="password" type="password" class="form-control" style="width:200px;" placeholder="Password" value="${addinternaluserformbean.password}"/>
<br>

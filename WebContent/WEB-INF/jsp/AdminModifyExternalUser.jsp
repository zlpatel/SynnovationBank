...
<input name="fname"  class = "form-control" style="width:200px;" placeholder = "First Name" maxlength="15" value="${modifyexternaluserformbean.fname}"/>
<br>
<input name="lname"  type="text" class = "form-control" style="width:200px;" placeholder = "Last Name" maxlength="14" value="${modifyexternaluserformbean.lname}"/>
<br>
<input name="address"  type="text" class = "form-control" style="width:200px;" placeholder = "Address" maxlength="50" value="${modifyexternaluserformbean.address}"/>
<br>
...
<br>
--%><input name="email"  type="text" class = "form-control" style="width:200px;" placeholder = "Email" maxlength="30" value="${modifyexternaluserformbean.email}"/>
<br><input name="username"  class = "form-control" style="width:200px;" placeholder = "Username" maxlength="15" value="${modifyexternaluserformbean.username}" readonly/>
<br>
